...
import fr.simplon.sondages.dto.ChangePasswordForm;
import fr.simplon.sondages.dto.CreateUserForm;
...
public class UsersController
{
    ...
    public UsersController(
            PasswordEncoder pPasswordEncoder, UserDetailsManager pUserDetailsManager)
    {
    ...
    public String subscribe(@ModelAttribute(name = "user") @Valid CreateUserForm user, BindingResult validation, Model model)
    {
